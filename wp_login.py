# wpdetect.py - Detects if a server is running wordpress
 #outputs list to WP_SERVERS.txt.
# Dumps servers to temp wp.txt for loop scanning using wpload.py
#  Example: wpdetect.py ip_list.txt
#  https://github.com/00xZ/WordPress-Detect-Scan/tree/main
